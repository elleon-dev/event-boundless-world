    ...
    <section id="contacto" className="py-20 bg-background">
      <div className="container max-w-3xl">
        ...
        <div className="bg-card rounded-xl shadow-md p-6 md:p-10">
          <h3 className="text-lg font-display font-semibold text-foreground mb-6">Solicita tu Consulta Gratuita</h3>
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button type="submit" className="w-full py-3 rounded-md bg-accent text-accent-foreground font-semibold text-sm hover:opacity-90 transition-opacity">
              Enviar Solicitud
            </button>
          </form>
        </div>
