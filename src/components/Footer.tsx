...
const Footer = () => {
  return (
    <footer className="bg-brown-dark text-primary-foreground py-14">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 mb-10">
          <div>
            ...
            <div className="flex gap-3 mt-4">
              ...
              <a href="#" className="hover:opacity-70 transition-opacity" aria-label="YouTube"><Youtube className="w-5 h-5" /></a>
            </div>
          </div>
